...
<main>
    <nav>
        ...
        <form action="/escaperpg/aventures/avent/cartes.php" target="_blank" rel="noreferrer" method="post"><input
                    type="submit" name="cartes" value="Cartes"></form>
    </nav>
    <div id="txt">
        ...
        <?php elseif (isset($_POST['suivant'])): ?>
            <p>
                ...
                <br>
                Malgré tout, vous vous endormez le sourire aux lèvres, en repensant à tout ce qu'il s'est passé depuis
                la semaine dernière.
            </p>
        ...
        <?php elseif (isset($_POST['knock'])): ?>
            ...
            <div class="dialogue">
                ...
                <div class="bulleperso">
                    <p>
                        Il y a quelques jours, j'ai reçu une lettre d'un mystérieux expéditeur me disant que ton
                        grand-père et toi lui avez été d'un grand secours.<br>
            ...
            <p>
                ...
                Vous n'en avez jamais vu de pareil, elle comporte des motifs représentant des rennes qui ont l'air
                d'avoir été gravés par l'artiste le plus talentueux qui existe.
                Sur le dessus, un disque représentant un flocon de neige a été taillé et l'ensemble est peint avec des
            ...
            <div class="dialogue">
                ...
                <div class="bulleperso">
                    <p>
                        ...
                        Petit, je pensais que c'était le Père Noël qui me l'avait envoyée et je la montrais à tous mes
                        amis.
                        ...
                        <br>
                        Bien sûr, je sais que c'était ton grand-père qui l'avait fabriquée, mais il a toujours essayé de
                        me faire croire au Père Noël…<br>
                        <br>
                        ...
                        Ça m'a rappelé l'époque où tout était heureux et où j'aimais ton grand-père de tout mon
                        cœur.<br>
                        <br>
        ...
        <?php elseif (isset($_POST['suivant2'])): ?>
            <p>
                Stupéfiée, vous voyez que votre grand-père se tient là, dans l'encadrement de la porte, les bras croisés
                et un sourire chaleureux aux lèvres.<br>
                <br>
            ...
            <div class="dialogue">
                ...
                <div class="bulleperso">
                    <p>
                        J'ai proposé à grand-père de rester encore quelques jours avec nous. Nous avons du temps à
                        rattraper !
                    </p>
                </div>
            </div>
            ...
            <div class="dialogue">
                ...
                <div class="bulleperso">
                    <p>
                        Tu sais qui m'a envoyé cette lettre avec la toupie ? C'est signé P. N. mais je ne vois pas qui
                        cela peut être.
                    </p>
                </div>
            </div>
            ...
            <p>
                Votre père s'esclaffe, bientôt imité par votre mère et votre grand-père, puis vous ne pouvez vous
                empêcher de vous joindre à eux.<br>
                <br>
        ...
        <?php else: ?>
            ...
            <p>
                ...
                Une série de bips résonne alors dans l'entrepôt et, une nouvelle fois, vous êtes baignée dans une
                lumière presque aveuglante.
                Vous êtes soulevée du sol avec Arthur puis, au bout de quelques secondes à peine, la lumière se dissipe
                et vous reconnaissez le grenier de l'inventeur,
                avec ses cartons, ses piles de livres et de papiers en tous sens.
            </p>
            <div class="dialogue">
                <div class="portrait">
                    <img src="/escaperpg/images/avent/arthur.png" alt="arthur">
            ...
            <p>
                Vous le suivez et l'aidez à préparer un délicieux repas, tout en échangeant sur votre aventure et en lui
                posant des tonnes de questions, auxquelles il répond patiemment.
                <br>
                Après ce jour, vous ne verrez plus jamais Noël comme avant !
            </p>
            <p>
                La semaine passe à une vitesse folle et, quand samedi arrive et que votre père revient vous chercher
                pour le repas de Noël,
                c'est un peu mélancolique que vous quittez la maison de votre grand-père, avec une seule pensée :
                vivement l'an prochain !
            </p>
            <p>
                Cette année, le repas de famille se révèle beaucoup plus chaleureux.<br>
                Vous avez même l'impression que, pour une raison inconnue, Arthur et votre père se parlent comme si leur
                querelle était oubliée... incroyable !
            </p>
            <form action="fin" method="post">
