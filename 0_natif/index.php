...
<head>
    ...
    <meta charset="utf-8">
    <meta name="keywords"
          CONTENT="syrphin, emilien, francois, françois, escape, game, room, jdr, rpg, jeu, énigme, enigme, réflexion, reflexion, jeu, rôle, role"/>
            ...
            <div class="dialogue">
                ...
                <div class="bulleperso">
                    <p>
                        ...
                        <br>
                        Pour espérer en connaître leur dénouement, vous devrez vous-même incarner leurs protagonistes
                        afin de les mener vers une fin heureuse...
                        Du moins, je l'espère pour vous !<br>
                        <br>
                        Enfilez votre costume, chargez vos armes et, surtout, affûtez votre esprit pour vous en tirer
        ...
        <div class="cardalign">
            <div class="card">
                <div class="cardfond">
                    ...
                    <p>
                        EscapeRPG est un jeu où vous pourrez vivre des histoires en incarnant directement leur
                        personnage principal.<br>
                        <br>
                        Il vous faudra explorer les lieux qui vous sont présentés pour trouver des indices et avancer
                        dans l'histoire,
                        car vous serez parfois confronté à des événements où vous devrez faire preuve de logique et de
                        réflexion pour espérer vous en sortir.
                    </p>
                </div>
            </div>
            <div class="card">
                <div class="cardfond">
                    ...
                    <p>
                        ...
                        <br>
                        - Un <b>ordinateur</b> muni d'une connexion internet. Pour les scénarios multijoueurs, il sera
                        nécessaire de posséder plusieurs ordinateurs ayant accès à internet.<br>
                        - Des <b>feuilles de papier</b>, un <b>carnet</b> ou n'importe quel <b>logiciel éditeur de
                            texte</b> pour prendre des notes lors de vos enquêtes.<br>
                        - D'un peu de <b>temps</b> devant vous. Les différents scénarios sont assez complets et
                        demandent parfois <b>plusieurs heures</b> pour être résolus.<br>
                        <br>
                        Vous avez réuni tous ces éléments ? Dans ce cas, installez-vous confortablement dans votre
                        fauteuil et lancez-vous dans l'aventure !<br>
                    </p>
                </div>
            </div>
            <div class="card">
                <div class="cardfond">
                    ...
                    <p>
                        Si c'est la première fois que vous venez sur EscapeRPG, il vous est fortement recommandé de
                        prendre connaissance des quelques <a href="#bloc3">règles du jeu</a> pour mieux appréhender ce
                        qui vous attend par la suite.<br>
                        <br>
                        Une fois que ce sera fait, vous devriez commencer par jouer le <a
                                href="/escaperpg/aventures/lastparty/index.php">scénario de découverte</a> !
                    </p>
                </div>
            </div>
        </div>
