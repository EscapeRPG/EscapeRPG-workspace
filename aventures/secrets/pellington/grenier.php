	...
	<body onload="chargement()">
		...
		<div id="bloc_page">
			...
			<div id="txt">
				<p>
					<div id="enigme">
						<a href="/escaperpg/images/secrets/pellgrenier.png" rel="lightbox[invent]"><img src="/escaperpg/images/secrets/pellgrenier.png"></a>
					</div>
					<br>
					Le grenier présente également un laboratoire, mais le docteur Pellington semble avoir consciencieusement caché toutes les informations sur ce qu'il menait ici, s'il ne les a pas tout simplement détruites.<br>
					<br>
					Vous sentez que les expériences menées ici n'avaient rien de conventionnel et les recherches rien de légal...
				</p>
			</div>
		</div>
