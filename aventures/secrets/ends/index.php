...
<html lang="fr">
	<head>
		...
		<meta charset="utf-8">
		<title>Erreur - Secrets Familiaux</title>
	</head>
	...
	<body onload="chargement()">
		...
		<div id="bloc_page">
			<nav>
				...
				<div id="inventairefooter">
					<input type="submit" onclick="inventaireshow()" value="INVENTAIRE">
				</div>
				<div id="motsdepasse">
					<input type="submit" onclick="mdpshow()" value="NOTES">
				</div>
			...
			<div id="txt">
				<?php
					echo'
						<p>
							Bien tenté, mais ça ne marchera pas comme ça !<br>
							<br>
