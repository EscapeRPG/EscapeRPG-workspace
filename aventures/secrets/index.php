					...
					if (isset($_POST['new']))
						{
							...
							echo '
								<p>
									...
									<br>
									Vous êtes Bastian Deckard, un jeune inspecteur de police de Boston. Il y a deux jours, vous avez reçu une missive indiquant que votre oncle, William Deckard, était décédé.
									Les obsèques sont prévues ce soir à 18h et c\'est pourquoi vous êtes revenu à Arkham.<br>
									Votre père étant mort en 1917, vous êtes le dernier héritier de la famille Deckard et c\'est à vous que revient l\'antique manoir familial, ainsi que toutes les affaires de feu votre oncle.<br>
									Cela vous demandera un peu de temps pour organiser le tout et voir ce que vous comptez garder, mais vous pourrez sans doute tirer un bon bénéfice de la revente de ses biens.<br>
									<br>
									...
									<div class="dialogue">
										...
										<div class="bulleperso">
											<p>
												...
												Je vous conseille de vous rendre sur <a href="https://www.youtube.com/watch?v=7bW75OwVXZI&list=PLggiqSd087TSku31JHz90pWoQOooERZON" target="_blank" rel="noreferrer">ce lien</a> pour plus d\'immersion !<br>
												<br>
