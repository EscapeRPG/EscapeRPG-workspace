<?php include_once $_SERVER['DOCUMENT_ROOT'] . "/escaperpg/includes/entete.php"; $_SESSION['plancurrent'] = "a"; ?>
<!DOCTYPE html>
<html lang="fr">
	<head>
		...
		<meta charset="utf-8">
		<title><?php if ($_SESSION['bvisited'] OR $_SESSION['fvisited']) { echo'Laboratoire B'; } else {echo'Labratrum B'; } ?> - Station GAEA-1</title>
	</head>
	...
	<body onload="chargement()">
		...
		<div id="bloc_page">
			...
			<div id="txt">
				<?php if ($_SESSION['bvisited'] OR $_SESSION['fvisited']): ?>
					<p>
						Vous êtes dans le laboratoire B !
					</p>
							
					<?php $_SESSION['atested'] = true; ?>
					<?php $_SESSION['avisited'] = true; ?>
