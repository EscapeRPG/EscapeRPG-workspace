<?php include_once $_SERVER['DOCUMENT_ROOT'] . "/escaperpg/includes/entete.php"; $_SESSION['plancurrent'] = "g"; ?>
<!DOCTYPE html>
<html lang="fr">
	<head>
		...
		<meta charset="utf-8">
		<title><?php if ($_SESSION['poweron']) { echo'Couloir E'; } else { echo'Kurdior E'; } ?> - Station GAEA-1</title>
	</head>
		...
		<div id="bloc_page">
			...
			<div id="txt">
				<?php if ($_SESSION['poweron']): ?>
					<p>
						Vous êtes dans le couloir E !
					</p>
				
					<?php $_SESSION['gtested'] = true; ?>
					<?php $_SESSION['gvisited'] = true; ?>
