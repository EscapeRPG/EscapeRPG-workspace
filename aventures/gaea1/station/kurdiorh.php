<?php include_once $_SERVER['DOCUMENT_ROOT'] . "/escaperpg/includes/entete.php"; $_SESSION['plancurrent'] = "i"; ?>
<!DOCTYPE html>
<html lang="fr">
	<head>
		...
		<meta charset="utf-8">
		<title><?php if ($_SESSION['poweron']) { echo'Couloir H'; } else { echo'Kurdior H'; } ?> - Station GAEA-1</title>
	</head>
		...
		<div id="bloc_page">
			...
			<div id="txt">
				<?php if ($_SESSION['poweron']): ?>
					<p>
						Vous êtes dans le couloir H !
					</p>
					
					<?php $_SESSION['itested'] = true; ?>
					<?php $_SESSION['ivisited'] = true; ?>
