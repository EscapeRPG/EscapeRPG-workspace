		...
		<main>
			...
			<div id="txt">
				<?php if (isset($_POST['avancer'])): ?>
					<?php switch (handleSpecialChars($_POST['enavant'])): ?>
						<?php case "allonsycapitaine": ?>
							...
							<p>
								D'un hochement de tête silencieux accompagné d'un léger sourire, vous adressez à la jeune recrue votre fierté.
								Après tout, Logan a parcouru un long et périlleux chemin pour en arriver là, en peu de temps et s'en sort admirablement bien.<br>
								<br>
				...
				<?php elseif (isset($_POST['suite'])): ?>
					<audio src="/escaperpg/sons/ambria/cite.mp3" autoplay></audio>
					<p>
						Avançant entre les bâtiments délabrés et recouverts de végétation, vous vous enfoncez au cœur de la cité, Logan à vos côtés.
						...
						Les restes d'étals et de tentures qui ont survécu aux ravages du temps vous laissent à penser qu'il s'agissait d'une place de marché,
						...
						S'il ne devait y avoir qu'un endroit où trouver des richesses, vous pariez que c'est ici que vous les obtiendrez.
					</p>
					<div class="dialogue">
				...
				<?php else: ?>
					...
					<p>
						...
						Les hommes avec vous laissent libre cours à leur joie et vous ne pouvez vous empêcher de la partager avec eux.<br>
					...
					<?php if (!in_array('Première prime', $_SESSION['mdp'])){
						$_SESSION['mdp'][] = 'Première prime';
					}
					?>
				<?php endif; ?>
			</div>
