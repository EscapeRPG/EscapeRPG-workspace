			...
			<div id="txt">
				<?php if (isset($_POST['suivant'])): ?>
					<?php if ($_SESSION['sullivanconfiance'] <= 70): ?>
						...
						<?php if (!in_array('Rassemble les gars', $_SESSION['mdp'])) $_SESSION['mdp'][] = 'Rassemble les gars'; ?>
					<?php else: ?>
						<audio src="/escaperpg/sons/ambria/grottetorche.mp3" autoplay></audio>
						<div class="dialogue">
							<div class="portrait">
						...
						<?php if (!in_array('Fais venir les gars', $_SESSION['mdp'])) $_SESSION['mdp'][] = 'Fais venir les gars'; ?>
					<?php endif; ?>
				...
				<?php elseif (isset($_POST['avancer'])): ?>
					<?php switch (handleSpecialChars($_POST['logan'])): ?>
						<?php case "quefaisonsnous": ?> <!-- Les deux joueurs ont moins de 70 de confiance. -->
							...
							<?php break; ?>
						<?php case "bougezpas": ?> <!-- Le capitaine a moins de 70 de confiance mais pas Logan -->
							<audio src="/escaperpg/sons/ambria/prisontombe.mp3" autoplay></audio>
							<p>
							...
							<?php break; ?>
						<?php case "sortirdela": ?> <!-- Le capitaine a 70 ou plus de confiance mais pas Logan -->
							<audio src="/escaperpg/sons/ambria/prisontombe.mp3" autoplay></audio>
							<p>
								Passant le premier, vous avancez vers le butin.<br>
								L'ivresse du gain vous ayant fait momentanément oublier toute prudence, vous vous arrêtez net dans votre élan en sentant une dalle s'enfoncer sous vos pieds.
							...
							<?php break; ?>
						<?php case "attendezcapitaine": ?> <!-- Les deux joueurs ont 70 ou plus de confiance -->
							<audio src="/escaperpg/sons/ambria/prisontombe.mp3" autoplay></audio>
							<p>
								Passant le premier, vous avancez vers le butin.<br>
								L'ivresse du gain vous ayant fait momentanément oublier toute prudence, vous vous arrêtez net dans votre élan en sentant une dalle s'enfoncer sous vos pieds.
				...
				<?php elseif (isset($_POST['attendre'])): ?>
					<?php switch (handleSpecialChars($_POST['mutinerie'])): ?>
						<?php case "vousavezraison": ?> <!-- Logan participe à la mutinerie -->
							...
							<?php break; ?>
						<?php case "jevoussuis": ?> <!-- Logan ne participe pas à la mutinerie -->
							<audio src="/escaperpg/sons/ambria/recuptresor.mp3" autoplay></audio>
							<div class="dialogue">
								<div class="portrait">
									<img src="/escaperpg/images/ambria/loganbarthelemymini.png" alt="logan barthélémy">
				...
				<?php elseif (isset($_POST['reagir'])): ?>
					<?php switch (handleSpecialChars($_POST['levers'])): ?>
						<?php case "preparezvous": ?>
							<div id="succespopup">
								<?php
								$scenario = 'ambria';
								$nom = 'fidele';
