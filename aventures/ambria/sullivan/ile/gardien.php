...
<?php case "ilabouge": ?>
            ...
            <p>
                ...
                Vous attrapez Logan par l'épaule et le poussez sur le côté alors que la statue lève une jambe, puis
                l'autre, pour se redresser et sortir de son emplacement.<br>
                Vous reculez prestement pour vous mettre hors de danger et hurlez à vos hommes de se préparer à
                l'affrontement.<br>
                Le golem d'or tourne sa tête pour observer autour de lui, comme pour évaluer la situation.
                Avisant Logan, qui s'est retrouvé séparé du groupe, il commence à lever son énorme bras et s'apprête
                manifestement à le frapper.<br>
                <br>
        ...
        <?php endswitch; ?>
        <?php elseif (isset($_POST['souffler'])): ?>
            ...
            <p>
                ...
                De votre côté, vous prenez un peu de recul pour tenter d'apercevoir Logan, toujours juché sur la
                terrasse.<br>
            ...
            <p>
                Quelques hommes s'éloignent vers les restes d'étals sur la place où ils ont déposé leur matériel un peu
                plus tôt,
                puis reviennent avec une corde qu'ils lancent à Logan.
                Le nouveau marin s'empresse d'utiliser les créneaux de la terrasse comme point d'accroche pour y faire
                un nœud et descendre en rappel.
            </p>
            <div class="dialogue">
                <div class="bulleperso2">
                    <p>
                        Parfait !<br>
                        <br>
                        On devrait plus avoir trop d'problème maintenant. Mais faites quand même gaffe quand on sera à
                        l'intérieur,
        ...
        <?php elseif (isset($_POST['souffler2'])): ?>
            <audio src="/escaperpg/sons/ambria/cite.mp3" autoplay></audio>
            <p>
        ...
        <?php elseif (!empty(array_intersect(array_keys($_POST), ['1golem3', '2golem3', '3golem3', '4golem3', '5golem3']))): ?>
            ...
            <p>
                Concentré au maximum, vous appuyez sur la détente et avez le temps de voir la suite des événements comme
                si tout se déroulait au ralenti.<br>
                Le chien qui pivote, venant percuter la lamelle de fer. L'étincelle qui se crée et vient embraser la
                poudre. La détonation.
                La flamme et la fumée. La balle qui est éjectée, décrivant une trajectoire en ligne droite vers sa
                cible.<br>
                ...
                Et puis il s'écroule au sol, soulevant un épais tapis de poussière vous obligeant à vous protéger les
                yeux de votre bras.
                Lorsque le nuage s'évapore, vous constatez que la statue est redevenue inerte et que ce gardien de la
                cité est maintenant vaincu.
            </p>
            <div class="dialogue">
                <div class="bulleperso2">
                    <p>
        ...
        <?php else: ?>
            ...
            <p>
                ...
                <br>
                Et puis rien.<br>
                Le colosse achève de se relever et frappe du poing la terrasse où se trouve Logan, la faisant
                s'écrouler.
                ...
                C'est alors que le reste de l'équipage encore présent lui envoie une volée de balles, tous ayant sorti
                leur pistolet.<br>
                L'un des gars fait mouche et vous entendez comme une sorte d'explosion étouffée tandis que le colosse se
                raidit.
                Une ou deux secondes passent, semblant durer une éternité.<br>
                Et puis il s'écroule au sol, soulevant un épais tapis de poussière vous obligeant à vous protéger les
                yeux de votre bras.
                Lorsque le nuage s'évapore, vous constatez que la statue est redevenue inerte et que ce gardien de la
                cité est maintenant vaincu.<br>
                <br>
        ...
        <?php elseif (isset($_POST['combat3']) || isset($_SESSION['combat3'])): ?>
                    ...
                    <div id="golem3gemme<?= $i ?>">
                        <form action="gardien" method="post">
                            <button type="submit" name="<?= $i ?>golem3">
                                <img src="/escaperpg/images/ambria/golem3gemme.png" class="cibletir"
                                     alt="gemme <?= $i ?>">
                            </button>
                        </form>
                    </div>
            ...
            <p>
                Le golem redresse peu à peu sa tête et vous apercevez des gemmes encastrées dans son front, brillant
                d'un vif éclat surnaturel.<br>
                <br>
                Peut-être que tirer dedans permettra de briser l'enchantement permettant à la créature de se mouvoir ?
                Malheureusement, celle-ci étant en train de se redresser, la fenêtre de tir dont vous disposez est très
                courte et vous n'aurez sans doute droit qu'à un seul essai.<br>
                Vous brandissez votre pistolet et expirer lentement pour réduire au maximum les tremblements de votre
                main, prêt à faire feu.
            </p>

        <?php
        $reponse = "Tirez sur la quatrième pierre précieuse.";
        $indice1 = "Il vous faut tirer sur l'une de ces gemmes, mais comment savoir laquelle ?";
        $indice2 = "Logan doit pouvoir vous aider.";
        $indice3 = "Dites-lui de bien observer son environnement, quelque chose doit faire écho à ce que vous voyez.";
        ...
        <?php case "maintenant": ?>
            ...
            <p>
                ...
                vous voyez votre compagnon armer son bras et frapper de toutes ses forces dans l'ouverture ainsi
                créée.<br>
                <br>
                ...
                Au lieu de cela, le jeune homme est propulsé en arrière par l'un des soubresauts et atterrit sur la
                terrasse surplombant l'entrée.
                Vous espérez qu'il a survécu au choc.<br>
                <br>
                Toujours saisie de tremblements d'une violence rare, la statue animée finit par flancher et tombe à
                moitié,
                son immense tête frappant le sol à quelques mètres de vous.
                Cependant, votre adversaire ne semble pas vouloir s'avouer vaincu et commence à prendre appui pour se
                redresser.<br>
                <br>
        ...
        <?php default: ?>
            <p>
                Êtes-vous sûr d'avoir bien entendu ce que votre compagnon vous a dit ou de lui avoir fourni la bonne
                information ?
            </p>
            <form action="gardien" method="post">
        ...
        <?php elseif (isset($_POST['combat2']) || isset($_SESSION['combat2'])): ?>
            ...
            <p>
                ...
                vous beuglez et faites de grands mouvements pour attirer l'attention du golem tout en prenant soin de
                rester à distance.<br>
        ...
        <?php
        $reponse = "La bonne séquence de couleurs est rouge bleu jaune rouge jaune vert bleu vert.";
        $indice1 = "Peut-être pouvez-vous trouver quelque chose autour de vous pour aider Logan à escalader le géant ?";
        $indice2 = "Quelles sont les particularités que Logan voit de son côté qui pourraient correspondre aux informations dont vous disposez ?";
        $indice3 = "Avez-vous remarqué la frise sur les colonnes ? Logan est en train de grimper, du bas vers le haut.";
        include $_SERVER['DOCUMENT_ROOT'] . "/escaperpg/includes/indices.php";
        ...
        <?php if (isset($_POST['1golem'])): ?>
            <audio src="/escaperpg/sons/ambria/gardien.mp3" autoplay></audio>
            <p>
                Vous pensez avoir repéré un point faible mais celui-ci se trouve trop en hauteur et vous comprenez qu'il
                va vous falloir escalader le corps de cette chose.<br>
                <br>
                Vous vous lancez dans sa direction, avec la ferme intention de vous agripper aux reliefs de la statue
                mouvante pour vous hisser.
                Malheureusement, cette dernière vous repère et balance son bras dans votre direction pour vous balayer.
                En catastrophe, vous vous stoppez net dans votre élan et effectuez un roulé-boulé pour esquiver de
                justesse l'attaque meurtrière.<br>
                <br>
            ...
            <div class="dialogue">
                <div class="bulleperso2">
                    <p>
                        Merde !<br>
                        Logan, essaye de grimper sur son dos, il a un point faible sur l'<span
                                class="mdp2">épaule</span> !
                    </p>
                </div>
                <div class="portrait2">
                    <img src="/escaperpg/images/ambria/sullivanmasonmini.png" alt="capitaine sullivan mason">
        ...
        <?php else: ?>
            ...
            <p>
                ...
                mouvante pour vous hisser.
                Malheureusement, cette dernière vous repère et balance son bras dans votre direction pour vous balayer.
                En catastrophe, vous tentez de vous stopper et de sauter sur le côté pour esquiver, mais trop emporté
                dans votre élan, vous réagissez un instant trop tard.
                Vous parvenez à échapper au gros de l'attaque mais le golem parvient malgré tout à vous frapper au
                niveau de la hanche, vous envoyant bouler un peu plus loin avec une douleur fulgurante.<br>
                <br>
                Vous relevant péniblement, vous constatez du coin de l'œil qu'une plaque au niveau de son épaule semble
                légèrement défaite, révélant les mécanismes internes.
                Vous comprenez aussitôt que c'est plutôt ici qu'il va falloir attaquer, mais le golem se tourne pour
                vous faire face, à présent.
            </p>
            <div class="dialogue">
                <div class="bulleperso2">
                    <p>
        ...
        <?php elseif (isset($_POST['combat']) || isset($_SESSION['combat'])): ?>
            ...
            <p>
                Le golem vous tournant le dos, vous vous dites que vous avez une chance de le frapper. Mais comment
                trouver son point faible ?
            </p>

        <?php
        $reponse = "Cliquez sur la gemme bleue.";
        $indice1 = "Avez-vous remarqué les motifs sur le corps du golem ?";
        $indice2 = "Essayez de suivre le chemin partant du motif en forme de triangle, il vous mènera jusqu'au point faible du monstre.";
        $indice3 = "Logan voit l'autre côté du colosse et vous aidera à suivre le chemin.";
        include $_SERVER['DOCUMENT_ROOT'] . "/escaperpg/includes/indices.php";
        ...
        <?php else: ?>
            ...
            <p>
                ...
                Se déployant, ils foncent vers les débris des statues d'or et commencent à récupérer les blocs les moins
                imposants pour les rassembler en tas, afin de les ramener lorsque vous rentrerez.<br>
                De son côté, Logan se dirige vers le colosse encore intact et l'observe avec attention.<br>
                De votre côté, vous restez quelques instants en retrait, savourant votre triomphe tout en observant vos
                hommes.<br>
                <br>
                ...
                Vous regardez autour de vous mais ne voyez aucun danger. Malgré le tremblement, le palais semble être
                suffisamment en bon état pour ne pas risquer de s'écrouler.<br>
                <br>
