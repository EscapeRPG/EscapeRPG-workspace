    ...
    <main>
        ...
        <div id="txt">
            ...
            <?php if (isset($_POST['suivant'])): ?>
                ...
                <p>
                    Vous vous avancez dans l'encadrure de la porte défoncée.
                    Devant vous se tient un homme relativement âgé brandissant un tison et affichant une expression se voulant sans doute menaçante.
                </p>
                <div class="dialogue">
                    <div class="portrait">
                        <img src="/escaperpg/images/ambria/louis.png" alt="louis">
                    </div>
            ...
            <?php elseif (isset($_POST['inspecter'])): ?>
                <?php if (str_replace($search, $replace, stripslashes($_POST['look'])) == "bourseencuir"): ?>
                    ...
                    <?php
                    if (!in_array('bourse', $_SESSION['inventaire'])) {
                        $_SESSION['inventaire'][] = "bourse";
                    }
                    ?>
                <?php else: ?>
                    <p>
