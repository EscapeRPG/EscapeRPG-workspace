        ...
        <div id="txt">
                ...
                <?php switch (handleSpecialChars($_POST['ask'])):
                    case "logan": ?>
                        <div class="dialogue">
                            ...
                            <div class="bulleperso">
                                <p>
                                    Qui ça ?<br>
                                    Oh, oui ! Le p'tit nouveau ! Il était avec Barthy un peu plus tôt pour apprendre les cordages,
                                    mais je sais pas ce que les gars lui ont demandé après ça.
                                </p>
                            </div>
                        </div>
                    ...
                    case "jake": ?>
                        <div class="dialogue">
                            ...
                            <div class="bulleperso">
                                <p>
                                    Ah ! Il est passé un peu plus tôt, oui.
                                    J'crois qu'il est parti pioncer un peu ou grailler, vous devriez aller voir par là-bas.
                                </p>
                            </div>
                        </div>
                        <form action="pontinferieur" method="post">
            ...
            <?php else: ?>
                ...
                <p>
                    ...
                    Les barils de poudre ainsi que les boulets sont entassés à portée pour faciliter leur utilisation
                    et permettre à votre équipage d'être le plus réactif possible en cas d'attaque.<br>
                    Un peu plus loin, dans un espace aménagé spécialement, se trouve le <span class="lieu">quartier des équipages</span>
                    où les hommes peuvent s'allonger dans les branles lorsqu'ils sont de repos.
