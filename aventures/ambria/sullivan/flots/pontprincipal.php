        ...
        <div id="txt">
            <?php if (isset($_POST['demander'])): ?>
                <?php switch (str_replace($search, $replace, stripslashes($_POST['ask']))):
                    case "logan": ?>
                        ...
                        <?php if (!in_array('Jake', $_SESSION['mdp'])) {
                            $_SESSION['mdp'][] = 'Jake';
                        }
                        ?>
                    <?php break;
            ...
            <?php else: ?>
                ...
                <p>
                    ...
                    Vous vous penchez quelques instants par-dessus le garde-fou,
                    le temps de sentir les embruns caresser votre visage buriné par le sel marin et le soleil éblouissant.
