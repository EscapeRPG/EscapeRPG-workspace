    ...
    <main>
        ...
        <div id="txt">
            ...
            <?php elseif (isset($_POST['suivant3'])): ?>
                ...
                <?php if ($_SESSION['sullivanconfiance'] == 90): ?>
                    <p>
                    ...
                    ';
                <?php elseif ($_SESSION['sullivanconfiance'] == 80): ?>
                    <p>
            ...
            <?php elseif (isset($_POST['suivant4']) || isset($_SESSION['ambriacabine'])): ?>
                <p>
                ...
                <ul class="reflexion-etagere">
                    ...
                    <li>- Le rhum se conserve mieux s'il n'est pas posé près d'une source de lumière ou de chaleur et devrait donc être posé le plus loin possible de l'une d'elles.</li>
                ...
                $reponse = `La caisse étant trop lourde, placez-la dans l'emplacement tout en bas.<br>
                        Comme le pistolet doit être vers le centre et que l'une des étagères sera vide au final,
                        il faut le placer juste à côté des livres sur la deuxième étagère en partant du haut.<br>
                ...
                $indice1 = "Vu le nombre d'objets à ranger, l'une des étagères se trouvera complètement vide.";
                $indice2 = "Il s'agit de la seconde étagère en partant du bas.";
                $indice3 = "Faites bien attention de placer la bouteille de rhum le plus loin possible des bougies et de la lampe.";
