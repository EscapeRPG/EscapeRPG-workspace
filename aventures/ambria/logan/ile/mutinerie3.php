			...
			<div id="txt">
				<?php
					echo'
						...
						<p>
							Attirant aussitôt l\'attention, vous êtes repéré et tentez de fuir aussi vite que possible, mais vous êtes bien vite rattrapé par des hommes surgissant de tous les côtés.
						</p>
						<div class="dialogue">
							<div class="portrait">
