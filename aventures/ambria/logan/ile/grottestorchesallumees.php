					...
					if ($_SESSION['portescite'])
						{
							echo'
								...
								<div id="enigmelieu">
									<img src="/escaperpg/images/ambria/logangrottestorchesallumees.png">
								</div>
								<p>
					...
					elseif (isset ($_POST['lueur']) OR $_SESSION['grottes'])
						{
							echo'
								...
								<p>
									...
									<br>
									En y débouchant, vous découvrez que les murs sont tapissés d\'une mousse verdâtre bioluminescente.<br>
									Vous prenez quelques instants pour admirer cette fascinante étrangeté naturelle, avant de reprendre la route.
								</p>
								<center>
