				...
				<?php
					echo'
						...
						<p>
							...
							Vous roulez sur le sol et sentez une violente douleur dans les côtes. Sans en être certain, vous redoutez de vous être cassé quelque chose.<br>
							<br>
