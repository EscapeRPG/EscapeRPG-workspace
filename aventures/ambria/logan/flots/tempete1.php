					...
					if ($_SESSION['affale'])
						{
							echo'
								...
								<p>
									Vous avez passé les derniers jours à vous familiariser à la vie à bord et vous avez plus d\'une fois grimpé les haubans pour vous préparer à ce genre de situation,
									ce qui vous permet d\'atteindre le haut du mât en un temps record, compte tenu des éléments qui se déchaînent autour de vous.<br>
