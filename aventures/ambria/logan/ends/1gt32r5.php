					...
					if (isset ($_POST['fin']) OR $_SESSION['fin'])
						{
							...
							echo '
								...
								<p>
									...
									Vous devez faire au mieux pour vous gagner une place auprès de l\'équipage et chaque erreur vous éloigne de ce but.<br>
							...
							for ($i = 1 ; $i <= $nombreDePages ; $i++) { echo '<a href="1gt32r5.php?page=' . $i . '">' . $i . '</a>'; }
							echo'
								</div>
								<center>
									<form action="1gt32r5.php" method="post">
										<fieldset>
					...
					else
						{
							...
							echo '
								...
								<p>
									...
									Se jetant quelques coups d\'œil pour savoir qui prendra la parole, ils mettent quelques secondes avant que Jake ne se décide et annonce,
									s\'approchant de la cage dans laquelle vous êtes enfermés avec le capitaine :
								</p>
								<div class="dialogue">
									<div class="portrait">
								...
								<p>
									...
									Arrivant au bout sans que rien ne se passe, ils commencent à fourrer les pièces,
									lingots et autres pierres précieuses dans les sacs en toile qu\'ils trimballent depuis votre arrivée sur l\'île.
									Vous assistez, impuissants, à ce manège, les voyant faire plusieurs allers et retours pour transporter les sacs en-dehors de la salle.<br>
									<br>
