					...
					if (isset ($_POST['fin']) OR $_SESSION['fin'])
						{
							...
							$rarete = 'succesdiamant';
							include_once $_SERVER['DOCUMENT_ROOT'] . "/escaperpg/includes/succesadd.php";
							$nouveausucces = '<img src="/escaperpg/images/succes/ambria/fin5logan.png"><span><u><b>Comme un vrai pirate !</b></u><br>En incarnant Logan, terminer l\'aventure et obtenir 5 étoiles</span>';
							$scenario = 'ambria';
							$description = 'étoile5logan';
							$cache = 'oui';
							$rarete = 'succesplatine';
							include_once $_SERVER['DOCUMENT_ROOT'] . "/escaperpg/includes/succesadd.php";
							echo'</div>';
							...
							for ($i = 1 ; $i <= $nombreDePages ; $i++) { echo '<a href="5cvq17.php?page=' . $i . '">' . $i . '</a>'; }
							echo'
								</div>
								<center>
									<form action="5cvq17.php" method="post">
										<fieldset>
					...
					else
						{
							...
							echo '
								...
								<p>
									...
									Il annonce que vous avez mérité votre part pour tout ce que vous avez accompli jusqu\'ici et l\'ensemble des gars grommelle d\'approbation.<br>
									<br>
									En voyant la part qui vous revient, vos yeux s\'illuminent d\'avidité et vous lancez au capitaine un regard de reconnaissance.<br>
									<br>
